...
python manage.py init_cpus_gpus_list --settings=ma_value.settings.local &&
python manage.py init_fake_companies --settings=ma_value.settings.local &&
python manage.py init_fake_users --settings=ma_value.settings.local &&
